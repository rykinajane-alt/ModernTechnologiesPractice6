...
|---|--------------------------|---------|-----|----|-----|-----|-----|-----|--------|
| 1 | Рыкина Евгения Андреевна | ПИ24-2в | x    | x   | x    | x    | x    | x    | x       |

## Внимание!
.java файлы были перемещены в part1/p_1_1/src/main/java/com/movies чтобы классы можно было вообще скомпилировать
и запустить. В прошлых папках вместо них лежит результат выполнения (result.txt)
---
